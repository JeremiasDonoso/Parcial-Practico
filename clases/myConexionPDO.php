	...
	public function updateSeguro($tabla, $data, $condiciones)
{
	...
	public function obtenerAreasInteres()
	{
		$sql = "SELECT * FROM areas_interes ORDER BY nombre";
		return $this->Arreglos($sql);
	}
	...
	public function guardarInscripcion($datos)
	{
		try {
			...
			// Guarda el inscriptor
			$this->insertSeguro("inscriptores", $datos);

			// Obtiene el id generado
			$id = $this->conexion->lastInsertId();

			// Guarda las áreas seleccionadas
			foreach ($temas as $tema) {

				$this->insertSeguro("inscriptor_temas", [

					"inscriptor_id" => $id,
					"area_interes_id" => $tema
